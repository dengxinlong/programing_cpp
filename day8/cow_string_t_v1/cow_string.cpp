...
//产生一个临时代理，返回给调用下标运算符处
Cow_string::Char_proxy Cow_string::operator[](std::size_t index)
{
    cout << "Char_proxy Cow_string::operator[](std::size_t index)" << endl;
...
//嵌套类 Char_proxy
std::ostream & operator<<(std::ostream & os, const Cow_string::Char_proxy & rhs)
{
